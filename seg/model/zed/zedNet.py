...
# completed and results are great 
class zedNetDWSepWithCCM(nn.Module):
    def __init__(
        self,
        n_channels, 
        n_classes,
        ...
        self.up3 = UpDWSep(256, 128 // factor, bilinear)
        self.att2 = NouveauAttention(64, reduction=2, AvgPoolKernelSize=11, AvgPoolPadding=5)
        self.up4 = UpDWSepCCM(128, 128, bilinear)
        self.att3 = NouveauAttention(128, reduction=2, AvgPoolKernelSize=31, AvgPoolPadding=15)
...
class zedNetDWSepWithCCMinAllOfIt(nn.Module):
    def __init__(
        ...
        self.up1 = UpDWSepCCMReverse(1024, 512 // factor, bilinear)
        self.up2 = UpDWSepCCMReverse(512, 256 // factor, bilinear)
        self.att1 = SCSEModule(in_channels=256//factor, reduction=16)
        self.up3 = UpDWSepCCMReverse(256, 128 // factor, bilinear)
        self.att2 = NouveauAttention(64, reduction=2, AvgPoolKernelSize=11, AvgPoolPadding=5)
        self.up4 = UpDWSepCCM(128, 128, bilinear)
        self.att3 = NouveauAttention(128, reduction=2, AvgPoolKernelSize=31, AvgPoolPadding=15)
...
# in process - results look worse 
class zedNetDWSepWithCCMAndRFB(nn.Module):
    def __init__(
        self,
        n_channels, 
        n_classes,
        ...
        self.inc = DoubleConvDWSepWithSmallRFB(n_channels, 72)
        self.down1 = DownDWSepCCM(72, 128)
        self.down2 = DownDWSepCCM(128, 256)
        self.down3 = DownDWSep(256, 512)
        factor = 2 if bilinear else 1
        self.down4 = DownDWSep(512, 1024 // factor)
        ...
        self.up3 = UpDWSep(256, 128 // factor, bilinear)
        self.att2 = NouveauAttention(64, reduction=2, AvgPoolKernelSize=11, AvgPoolPadding=5)
        self.up4 = UpDWSepCCMReverse(64 + 72, 128, bilinear)
        self.att3 = NouveauAttention(128, reduction=2, AvgPoolKernelSize=31, AvgPoolPadding=15)
...
# NOT COMPLETED YET .
class zedNetDWSepWithCCMmodeddedFromBest(nn.Module):
    def __init__(
        self,
        n_channels, 
        n_classes,
        ...
        self.up1 = UpDWSep(1024, 512 // factor, bilinear)
        self.up2 = UpDWSepCCMReverseReverseReverse(512, 256 // factor)
        self.att1 = SCSEModule(in_channels=256//factor, reduction=16)
        self.up3 = UpDWSep(256, 128 // factor, bilinear)
        self.att2 = NouveauAttention(64, reduction=2, AvgPoolKernelSize=11, AvgPoolPadding=5)
        self.up4 = UpDWSepCCM(128, 128, bilinear)
