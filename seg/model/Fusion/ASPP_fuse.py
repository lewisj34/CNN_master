...
from seg.model.zed.zedNet import SCSEModule
from seg.model.Fusion.fuse import MiniEncoderFuse
class SqueezeAndExitationFusion(nn.Module):
    def __init__(
        self, 
        cnn_model_cfg,
        trans_model_cfg,
        ...
        Replaces fusion modules with ASPP modules. 
        """
        super(SqueezeAndExitationFusion, self).__init__()
...
running the terminal right now so...') # SEE BELOW.... decoder = 'linear'
        ...
        self.att = SCSEModule(64 + 64, reduction=16)
