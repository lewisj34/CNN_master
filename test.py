...
from engineV2 import speed_testing, speed_testing_multi_gpu
...
def main(
    ...
    ****************************** USAGE ****************************** 
    ...
    print(f'Single GPU FPS test:')
    images=torch.randn((3, image_height, image_width))
    speed_testing(
        model,
        images.shape[2],
        images.shape[1],
    ...
    print(f'Multi GPU FPS test')
    speed_testing_multi_gpu(
        model,
        images.shape[2],
        images.shape[1],
        num_iters=10000,
