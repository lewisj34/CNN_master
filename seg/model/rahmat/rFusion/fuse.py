...
from ..rCNN.CNN_parts import Down, Up
...
class r_MiniEncoderFuse(nn.Module):
    def __init__(
        self, 
        in_chan_CNN, 
        in_chan_TRANS, 
        ...
        super(r_MiniEncoderFuse, self).__init__()
        ...
        self.down1 = Down(in_chan_CNN + in_chan_TRANS + 31, intermediate_chan)
        # self.super1 = SuperficialModule(nIn=intermediate_chan)
        self.down2 = Down(intermediate_chan, intermediate_chan)
        self.up1 = Up(intermediate_chan, intermediate_chan)
        # self.super2 = SuperficialModule(nIn=intermediate_chan)
...
if __name__ == '__main__':
    fuse_1_2 = r_MiniEncoderFuse(256, 64, 64, 1, fraction=0.5)
    fuse_1_4 = r_MiniEncoderFuse(256, 64, 64, 1, fraction=0.25)
    fuse_1_8 = r_MiniEncoderFuse(512, 128, 64, 1, fraction=0.125)
