...
from seg.model.PraNet.lib.Res2Net_v1b import res2net50_v1b_26w_4s
...
class PraNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x2_rfb = self.rfb2_1(x2) #; print(f'x2, x2_rfb.shape: {x2.shape, x2_rfb.shape}')        # channel -> 32
...
if __name__ == '__main__':
    ...
    lateral_map_5, lateral_map_4, lateral_map_3, lateral_map_2 = ras(input_tensor)
