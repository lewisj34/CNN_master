...
class ReverseAttentionCNNandlittleandBigTransformer(nn.Module):
    ...
    def forward(self, images):
        ...
        x_1_2 = self.inv_x_1_2(x_trans_sml, self.cnn_branch.x_1_2) # ;print(f'[x_1_2]: \t{x_1_2.shape}')
        x_1_4 = self.inv_x_1_4(x_trans_sml, self.cnn_branch.x_1_4) # ;print(f'[x_1_4]: \t{x_1_4.shape}')
        x_1_8 = self.inv_x_1_8(x_trans_sml, self.cnn_branch.x_1_8) # ;print(f'[x_1_8]: \t{x_1_8.shape}')
...
class ReverseAttentionCNNandlittleandBigTransformerModifiedCNNChannelstoFusionModule(nn.Module):
    """
    Similar to ReverseAttentionCNNandlittleandBigTransformer, except this one makes the input channels to the fusion modules the same as the transformer
    using 3x3 DWSep convolutions 
    """
    def __init__(
        self,
        cnn_model_cfg,
        ...
        self.DWSep_x_1_2 = nn.Sequential(
            SeparableConv2D(self.cnn_branch.x_1_2.shape[1], big_trans_model_cfg['num_output_trans'], kernel_size=3, padding=1, dilation=1),
            nn.BatchNorm2d(big_trans_model_cfg['num_output_trans']),
            nn.SiLU(True),
        )
        self.inv_x_1_4 = NegativeInvert(
            self.cnn_branch.x_1_4.shape[1], # changing this expansion to either lower or hgiher than the transformer is a hyperparam 
        ...
        self.DWSep_x_1_4 = nn.Sequential(
            SeparableConv2D(self.cnn_branch.x_1_4.shape[1], big_trans_model_cfg['num_output_trans'], kernel_size=3, padding=1, dilation=1),
            nn.BatchNorm2d(big_trans_model_cfg['num_output_trans']),
            nn.SiLU(True),
        )
        self.inv_x_1_8 = NegativeInvert(
        ...
        self.DWSep_x_1_8 = nn.Sequential(
            SeparableConv2D(self.cnn_branch.x_1_8.shape[1], big_trans_model_cfg['num_output_trans'], kernel_size=3, padding=1, dilation=1),
            nn.BatchNorm2d(big_trans_model_cfg['num_output_trans']),
            nn.SiLU(True),
        )

        self.DWSep_x_1_16 = nn.Sequential(
            SeparableConv2D(self.cnn_branch.x_1_16.shape[1], big_trans_model_cfg['num_output_trans'], kernel_size=3, padding=1, dilation=1),
            nn.BatchNorm2d(big_trans_model_cfg['num_output_trans']),
            nn.SiLU(True),
        )

        self.fuse_1_2 = MiniEncoderFuseDWSep(
            big_trans_model_cfg['num_output_trans'], # this is just the same as the expand channels from self.inv_x_1_2 above
            big_trans_model_cfg['num_output_trans'], 
            64, 
            1,
            stage = '1_2'
        ...
        self.fuse_1_4 = MiniEncoderFuseDWSep(
            big_trans_model_cfg['num_output_trans'], # this is just the same as the expand channels from self.inv_x_1_4 above
            big_trans_model_cfg['num_output_trans'], 
            64, 
            1, 
            stage='1_4'
        ...
        self.fuse_1_8 = MiniEncoderFuseDWSep(
            big_trans_model_cfg['num_output_trans'], # this is just the same as the expand channels from self.inv_x_1_8 above
            big_trans_model_cfg['num_output_trans'], 
            64, 
            1, 
            stage='1_8'
        ...
        self.fuse_1_16 = MiniEncoderFuseDWSep(
            big_trans_model_cfg['num_output_trans'], # this is just the same as the expand channels from self.inv_x_1_16 above
            big_trans_model_cfg['num_output_trans'], 
            64, 
            1, 
            stage='1_16'
    ...
    def forward(self, images):
        ...
        self.x_1_2 = self.fuse_1_2(self.cnn_branch.x_1_2 * x_1_2, self.big_trans.x_1_2)
        self.x_1_4 = self.fuse_1_4(self.cnn_branch.x_1_4 * x_1_4, self.big_trans.x_1_4)
        self.x_1_8 = self.fuse_1_8(self.cnn_branch.x_1_8 * x_1_8, self.big_trans.x_1_8)
        self.x_1_16 = self.fuse_1_16(self.cnn_branch.x_1_16, self.big_trans.x_1_16)
