...
class conferenceReverseAttentionCNNandlittleandBigTransformerWithZed(nn.Module):
    def __init__(
        self,
        cnn_model_cfg,
        big_trans_model_cfg,
...
class NewZedFusionNetworkDWSepWithCCMinDWModule(nn.Module):
    def __init__(
        self, 
        cnn_model_cfg,
        trans_model_cfg,
        ...
        super(NewZedFusionNetworkDWSepWithCCMinDWModule, self).__init__()
...
class NewZedFusionNetworkDWSepWithCCMinDWModuleInEveryUpDownModule(nn.Module):
    def __init__(
        ...
        super(NewZedFusionNetworkDWSepWithCCMinDWModuleInEveryUpDownModule, self).__init__()
...
# for conference paper basically the same as our best results except we have RFB in fusion module 
class conferencePaperRFBinFusion(nn.Module):
    def __init__(
        self, 
        cnn_model_cfg,
        trans_model_cfg,
        ...
        super(conferencePaperRFBinFusion, self).__init__()
...
# in process and results dont seem great. 
class NewZedFusionNetworkDWSepWithCCMinDWModuleAndSmallRFB(nn.Module):
    def __init__(
        self, 
        cnn_model_cfg,
        trans_model_cfg,
        ...
        super(NewZedFusionNetworkDWSepWithCCMinDWModuleAndSmallRFB, self).__init__()
        ...
        self.cnn_branch = zedNetDWSepWithCCMAndRFB(
            n_channels=cnn_model_cfg['in_channels'],
            n_classes=cnn_model_cfg['num_classes'],
            patch_size=cnn_model_cfg['patch_size'],
            bilinear=True,
...
# NOT COMPLETED YET .
class NewZedFusionNetworkDWSepWithCCMmoreCCMmoddedfromBest(nn.Module):
    def __init__(
        self, 
        cnn_model_cfg,
        trans_model_cfg,
        ...
        super(NewZedFusionNetworkDWSepWithCCMmoreCCMmoddedfromBest, self).__init__()
        ...
        self.cnn_branch = zedNetDWSepWithCCMmodeddedFromBest(
            n_channels=cnn_model_cfg['in_channels'],
            n_classes=cnn_model_cfg['num_classes'],
            patch_size=cnn_model_cfg['patch_size'],
            bilinear=True,
