...
class MultiScaleIoU(nn.Module):
    ...
    def forward(
        ...
        self.loss_mat[0] = loss_1_1_cnn
        self.loss_mat[1] = loss_1_2_trans
        self.loss_mat[2] = loss_1_2
        self.loss_mat[3] = loss_1_4
        self.loss_mat[4] = loss_1_8
        self.loss_mat[5] = loss_1_16

        weighted_avg_loss = (self.loss_mat@self.weights)/self.weights.sum()
        
        return 1 - weighted_avg_loss
