...
if __name__ == '__main__':
    ...
    for mode in mode_list:
        ...
        img = Variable(torch.rand(2, 10, 10, 10, 10))
        gat = Variable(torch.rand(2, 10, 10, 10, 10))
        net = GridAttentionBlock2D(in_channels=10, inter_channels=20, gating_channels=10, mode=mode, sub_sample_factor=(2,2))
