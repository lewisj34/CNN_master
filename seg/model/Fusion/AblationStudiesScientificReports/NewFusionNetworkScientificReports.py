...
class AblationStudyScientificReportsNoViTNoReplacement(nn.Module):
    def __init__(
        self, 
        cnn_model_cfg,
        trans_model_cfg,
        ...
        super(AblationStudyScientificReportsNoViTNoReplacement, self).__init__()
        ...
        self.with_fusion = with_fusion
        if self.with_fusion:
            self.fuse_1_2 = MiniEncoderFuseDWSepNoTrans( # NOTE: 64 classes trans output manually input here 
                self.cnn_branch.x_1_2.shape[1], 0, 64, 1, stage = '1_2')
            self.fuse_1_4 = MiniEncoderFuseDWSepNoTrans(
                self.cnn_branch.x_1_4.shape[1], 0, 64, 1, stage='1_4')
            self.fuse_1_8 = MiniEncoderFuseDWSepNoTrans(
                self.cnn_branch.x_1_8.shape[1], 0, 64, 1, stage='1_8')
            self.fuse_1_16 = MiniEncoderFuseDWSepNoTrans(
                self.cnn_branch.x_1_16.shape[1], 0, 64, 1, stage='1_16')
