"""
SAME AS transformerNoDecoder which gives create_transformerV4 which returns our
transformer with no decoder, but in this case we can adjust the number of input channels
to the transformer in the create_vit function. 
"""
...
def create_vit(model_cfg):
    ...
    model = VisionTransformer(
        ...
        channels=model_cfg['in_channels'], # what was adjusted in this file transformerNoDecoderAdjustableChannels
    )
...
def create_transformerV5(model_cfg, decoder='linear'):
    ...
    model = TransformerV4(encoder, decoder, n_cls=model_cfg["n_cls"], num_outputs_trans=num_output_trans)
